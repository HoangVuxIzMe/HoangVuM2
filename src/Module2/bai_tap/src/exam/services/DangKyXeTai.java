...
public class DangKyXeTai implements phucVu{
    private static Scanner sc = new Scanner(System.in);
    private static List<DvXeTai> xeTaiList = new LinkedList<>();
...
//        ReadAndWrite.readFileMaOto("D:\\Code_Module2\\HoangVuM2\\src\\Module2\\bai_tap\\src\\exam\\data\\phuongTien.csv");
        DvXeTai xeTai = new DvXeTai(soDangKy, tenChuXe,ngayDangKy);
        xeTaiList.add(xeTai);
        ReadAndWrite.writeFileXeTai(xeTaiList,"D:\\Code_Module2\\HoangVuM2\\src\\Module2\\bai_tap\\src\\exam\\data\\data\\gdkpt.csv");
    }

    @Override
    public void hienThi() {
        ReadAndWrite.readFileXeTai("D:\\Code_Module2\\HoangVuM2\\src\\Module2\\bai_tap\\src\\exam\\data\\data\\gdkpt.csv");
        for (DvXeTai xeTai : xeTaiList){
